...
class TopGUI(wx.Frame):
    ...
    def InitGUI(self):     
        ...
        # choice buttons
        butDefSize = (250, 30)  # tuple width, height
        ...
        self.imageBitmap = wx.StaticBitmap(self, -1, wx.Bitmap(image))
    ...
    # assign appropriate bindings to buttons
    def initializeQuestion(self):
        ...
        paint_no = int(random.random() * MAX_NUM) + 1  # database starts from 1
        ...
        while 1:
            temp = int(random.random() * MAX_NUM)+1
        ...
        corr_choice = int(random.random() * NUM_OF_CHOICES)
    ...
    def CorrectChoice(self, event):
        ...
        time.sleep(1)   # wait 1 second to let user digest correct answer
...
# function to process the question database as the beginning of the program.
...
def draw_image(paint_no):
    ...
    [width, height] = image_rescale(image)
